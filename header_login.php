			...
			<div class="profile-block">
				<div class="profile-wrapper">
					...
					<ul class="user-info-block">
						...
						<li><a href="profil.php?profile_tab=watched">История просмотров</a></li>
						<li id="user-menu-favourites"><a href="profil.php?profile_tab=favorites">Очередь <small>(<span id="user_menu_show_favourites_items_count">4</span>)</small></a></li>
						<li><a href="profil.php?profile_tab=recommendations">Рекомендации</a></li>
