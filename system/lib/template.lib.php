...
// print_arr($this, 1);
	...
	*/
	public function widget($widget, $vars=array()) {
		...
		require_once(SITE_ROOT . '/widgets/' . $widget_folder . $widget . '/.php');
	...
	*/
	public function renderWidget($widget, $widget_folder = '') {
		...
		if ( config::get('DEBUG') ) {
			print "\r\n\r\n<!-- START WIDGET /".$widget_folder."/".$widget."/.php -->\r\n\r\n";
		}
		...
		include SITE_ROOT.'/'.$widget_folder.$widget.'/.tpl';

		if ( config::get('DEBUG') ) {
			print "\r\n\r\n<!-- END WIDGET /".$widget_folder."/".$widget."/.tpl -->\r\n\r\n";
		}
		return ob_get_clean();
	}
